...
import {
  Form, Message, Divider, Dimmer, Accordion,
...
const GenralFaq = [
  { key: 'panel-baa', title: 'What character skills are used for calculations?',
...
Custom fits exported from pyfa will reflect the skills of the character selected when they were exported from pyfa'
  ...
  { key: 'panel-bas', title: 'Do effective hp and damage calculations consider damage types?',
...
const AddingFitsFaq = [
  { key: 'panel-baq', title: 'How do I add my own fits to simulations?',
    content: ''
  },
  { key: 'panel-baw', title: 'Are you going to steal my secret squirel elite pvp fits?',
    content: 'No, custom fits and settings are stored locally in the browser and not sent anywhere'
  },
  { key: 'panel-bae', title: 'Is there a limit to how many fits I can add?',
...
The exact number will depend on the exact fits along with your browser but it should always be atleast sevral hundred.'
  ...
  { key: 'panel-bar', title: 'Why do I have to use pyfa to add fits?',
...
Creating another fitting tool would be a large duplication of effort and would increase maintainance significantly'
  ...
  { key: 'panel-bat', title: 'Why pyfa rather than eft or both?',
...
function dataTypeExplanation(data) {
  ...
  return (
    <div>
    <Container text style={{ display: 'flex', width: '100%', alignItems: 'center', marginLeft: 'inherit' }}>
      <Image
        src={icon}
        centered={false}
        circular
...
const ShipFaq = [
  { key: 'panel-1a1', title: 'What are the exactly are the diffrent values?',
    content: shipTypeDataTypeInfo.map(dataTypeExplanation)
  },
  { key: 'panel-ba2', title: 'What do the module quality options correspond to?',
    content: 'Level 1B Contents'
  },
  { key: 'panel-ba3', title: 'Do the values include command bursts?',
    content: 'Yes, they include the bonuses from a perfect set of bursts provided by command ships'
  },
  { key: 'panel-ba4', title: 'How does tech 3 cruiser selection work?',
...
const FleetSimFaq = [
  { key: 'panel-2a1', title: 'What are the exactly are the diffrent values?',
    content: shipFitDataTypeInfo.map(dataTypeExplanation)
  },
  { key: 'panel-2b2', title: 'Are any weapon systems unimplemented or partially implemented?',
...
If you run into something not mentioned here that seems to give incorrect simulation results please consider filing a bug report.'
  ...
  { key: 'panel-ba3', title: 'How is ewar implemented?',
...
The practical impact of this is expected to be nearly zero outside of very contrived and neiche situations.'
  ...
  { key: 'panel-ba4', title: 'Which ewar systems are implemented?',
...
Note that drone, fighter or burst projector based variants are not implemented.'
  ...
  { key: 'panel-ba5', title: 'Are repairs implemented?',
...
Local repairs are not implemented at this time however there are plans to do so.'
  ...
  { key: 'panel-ba6', title: 'How are remote repairs implemented?',
...
The implementation is not limited specifically to logistics ships.'
  ...
  { key: 'panel-ba7', title: 'How do I change which ships are targeted first?',
...
This is mostly to prevent the AI making it much harder to test aproxamations of known situations.'
  ...
  { key: 'panel-ba8', title: 'How are drones and fighters implemented?',
...
the abbility to kill them is implemented.'
  ...
  { key: 'panel-ba9', title: 'How is ship movement implemented?',
...
fleets will typically warp out if they are being kited to hell.'
  ...
  { key: 'panel-ba11', title: 'Do ships try and match transversal?',
...
when the faster ship has far worse agility and far worse tracking (eg Ragnarocks shooting unproped armor Abbadons).'
  ...
  { key: 'panel-ba12', title: 'How do ships select their ideal range?',
    content: 'q'
  },
  { key: 'panel-ba13', title: 'Can I add my own fits to use in simulations?',
    content: 'w'
  },
  { key: 'panel-ba14', title: 'Where do the default fits come from?',
    content: 'e'
  },
  { key: 'panel-ba15', title: 'Why do none of the default fits have implants?',
    content: 'r'
  },
  { key: 'panel-ba16', title: 'Why are some of the default fits kinda wonky?',
    content: 't'
  },
  { key: 'panel-ba17', title: 'Is the simulation accurate?',
    content: 'y'
  },
  { key: 'panel-ba18', title: 'Why create an imperfect simulation?',
    content: 'u'
  },
  { key: 'panel-ba19', title: 'Is there a time limit on the simulations?',
    content: 'u'
  },
  { key: 'panel-b20', title: 'Why is my simulation finishing while both sides have ships left?',
    content: 'u'
  },
];
